...
import com.phucchinh.ecommerce.dto.ProductDto;
...
import com.phucchinh.ecommerce.serivce.AwsS3Service;
import com.phucchinh.ecommerce.serivce.interf.ProductService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public Response getAllProducts() {
        List<ProductDto> productList = productRepo.findAll(Sort.by(Sort.Direction.DESC,"id"))
                .stream().map(entityDtoMapper::mapProductToDtoBasic).toList();
        return Response.builder()
                .status(200)
    ...
    public Response getProductByCategory(Long categoryId) {
        ...
        List<ProductDto> productDtoList = products.stream().map(entityDtoMapper::mapProductToDtoBasic).toList();
        return Response.builder()
                .status(200)
